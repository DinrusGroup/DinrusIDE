...
namespace DSharp.Parser
{
    public class DTokens
    {
		...
		/// Russion keywords;
		/// </summary>
		public const byte RBool = 184;
		public const byte RByte = 185;
		public const byte RCdouble = 186;
		public const byte RCent = 187;
		public const byte RCfloat = 188;
		public const byte RChar = 189;
		public const byte RCreal = 190;
		public const byte RDchar = 191;
		public const byte RDouble = 192;
		public const byte RFalse = 193;
		public const byte RFloat = 194;
		public const byte RIdouble = 195;
		public const byte RIfloat = 196;
		public const byte RInt = 197;
		public const byte RIreal = 198;
		public const byte RLong = 199;
		public const byte RNull = 200;
		public const byte RReal = 201;
		public const byte RShort = 202;
		public const byte RTrue = 203;
		public const byte RUbyte = 204;
		public const byte RUcent = 205;
		public const byte RUint = 206;
		public const byte RUlong = 207;
		public const byte RUshort = 208;
		public const byte RVoid = 209;
		public const byte RWchar = 210;
        ...
        public static byte[] BasicTypes_Array = new[] { Bool, Byte, Ubyte, Short, Ushort, Int, Uint, Long, Ulong, Cent, Ucent, Char, Wchar, Dchar, Float, Double, Real, Ifloat, Idouble, Ireal, Cfloat, Cdouble, Creal, Void, RBool, RByte, RUbyte, RShort, RUshort, RInt, RUint, RLong, RUlong, RCent, RUcent, RChar, RWchar, RDchar, RFloat, RDouble, RReal, RIfloat, RIdouble, RIreal, RCfloat, RCdouble, RCreal, RVoid };

        public static BitArray BasicTypes = NewSet(Bool, Byte, Ubyte, Short, Ushort, Int, Uint, Long, Ulong, Cent, Ucent, Char, Wchar, Dchar, Float, Double, Real, Ifloat, Idouble, Ireal, Cfloat, Cdouble, Creal, Void, RBool, RByte, RUbyte, RShort, RUshort, RInt, RUint, RLong, RUlong, RCent, RUcent, RChar, RWchar, RDchar, RFloat, RDouble, RReal, RIfloat, RIdouble, RIreal, RCfloat, RCdouble, RCreal, RVoid);

		public static BitArray BasicTypes_Integral = NewSet(Bool, Byte,Ubyte,Short,Ushort,Int,Uint,Long,Ulong,Cent, Ucent, Char,Wchar, Dchar, RBool, RByte,RUbyte,RShort,RUshort,RInt,RUint,RLong,RUlong,RCent, RUcent, RChar,RWchar, RDchar);
		public static BitArray BasicTypes_FloatingPoint = NewSet(Float,Double,Real,Ifloat,Idouble,Ireal,Cfloat,Cdouble,Creal, RFloat,RDouble,RReal,RIfloat,RIdouble,RIreal,RCfloat,RCdouble,RCreal);
		public static BitArray BasicTypes_Unsigned = NewSet(Ubyte, Ushort, Uint, Ulong, Ucent, RUbyte, RUshort, RUint, RUlong, RUcent);

		public static BitArray CharTypes = NewSet (Char, Wchar, Dchar, RChar, RWchar, RDchar);
