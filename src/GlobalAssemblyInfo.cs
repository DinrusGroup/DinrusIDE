...
[assembly: AssemblyProduct("DinrusIDE")]
[assembly: AssemblyCopyright("2000-2013 Vit Klich")]
[assembly: AssemblyVersion(RevisionClass.Major + "." + RevisionClass.Minor + "." + RevisionClass.Build + "." + RevisionClass.Revision)]
[assembly: AssemblyInformationalVersion(RevisionClass.FullVersion + "-463ee024")]
...
internal static class RevisionClass
{
	...
	public const string Revision = "9663";
	...
	public const string FullVersion = Major + "." + Minor + "." + Build + ".9663";
}
